...
プールは種の 1,000 へ戻る(`TestStore_Spin_TripleSevenPaysTheWholePoolAndResetsToTheSeed`)。💎💎💎 はプール 5,000 を 1 チップも動かさない。
...
settle した抽選が「🏆 昨日の当選: <@u1> が 90チップ 獲得(2枚 / 1人)」を出し、残る 10 チップがジャックポットのプールへ入る。
